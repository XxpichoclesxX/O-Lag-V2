...
int main()
{
    SetConsoleTitleA("Cleaner by Picho");
    int choice;
menu:
    system("CLS");
    system("color c");
    ...
    cout << raw_str << endl;
    cout << "1: Limpiar red y archivos (Fase beta!!)\n";
    cout << "2: Check pc corrupted files\n";
    cin >> choice;
    if (choice == 1)
    {
    limpiar:
        ...
        system("color c");
        system("CLS");
        printf("Advertencia estas apunto de usar la fase beta del cleaner, deseas continuar?");
